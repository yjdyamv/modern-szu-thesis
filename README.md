...
**由于官方在线编辑器没有提供字体，因此你需要上传/font目录下的字体才可以正常显示字体。**
...
1. 在 VS Code 中安装 [Tinymist Typst](https://github.com/Myriad-Dreamin/tinymist) 。此插件负责语法高亮、错误检查、编译预览文档、格式化文档等功能。
...
3. 最后用 VS Code 打开生成的目录，打开 `master-thesis.typ` / `bachelor-thesis.typ` 文件，并按下 `Ctrl + K V` 进行实时编辑和预览。

![gallery](imgs/gallery.png)
![vsc-template](imgs/vsc-template.png)
...
> ```
>
> ![vsc-git-template](imgs/vsc-git-template.png)
...
- `bachelor-thesis.typ`文件是本科生模板
- `master-thesis.typ`文件是研究生模板(通过选择`doctype`是`master`还是`doctor`,来选择硕士和博士模板)
- `ref.bib`文件是参考文献放置处
- `images`里有示例图片
...
- 感谢 [OrangeX4](https://github.com/OrangeX4) 的[modern-nju-thesis](https://github.com/nju-lug/modern-nju-thesis)模板，此模板可使用性很强。本readme文件参照了此模板的readme文件编写。
- 感谢[tzhtaylor](https://github.com/tzhtaylor)的[modern-sjtu-thesis](https://github.com/tzhtaylor/modern-sjtu-thesis)模板，参考了页眉的实现与标题段前段后的实现。
- 感谢[NJU LUG](https://github.com/nju-lug)的[NJU THESIS](https://github.com/nju-lug/NJUThesis)，相比于其他latex模板有着详实的[文档](https://mirrors.ustc.edu.cn/CTAN/macros/unicodetex/latex/njuthesis/njuthesis.pdf)。NJU THESIS是一个优秀的latex模板，可以方便制作latex模板。

## 排版参考

- [深圳大学本科生毕业论文(设计)撰写规范及要求（修订）](https://jwb.szu.edu.cn/info/1358/2010.htm)
- [深圳大学研究生学位论文格式规范及格式模板（2024年1月）](https://gra.szu.edu.cn/info/1041/3551.htm)

...
- `master-thesis.typ`文件是研究生模板(通过选择`doctype`是master还是doctor,来选择硕士和博士模板)
- `ref.bib`文件是参考文献放置处
- `images`里有示例图片
...
- 感谢 [OrangeX4](https://github.com/OrangeX4) 制作的[modern-nju-thesis](https://github.com/nju-lug/modern-nju-thesis)模板，此模板可使用性很强。本readme文件参照了此模板的readme文件编写。
...
- 感谢[NJU THESIS](https://github.com/nju-lug/NJUThesis)详实的文档，这是相比于其他latex模板的极大优势，NJU THESIS是一个优秀的latex模板，可以方便制作latex模板
